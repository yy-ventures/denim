    ...
    :global
      ...
      > .container:nth-of-type(2) .content
        p
          ...
          font-size: max(16px, 1.5vw) !important
          @media (min-width: 601px)
            width: 80%
          margin: 0 auto
          text-align: center
