    ...
    Background(image="fabric_sourcing_background")
      ...
      Article
        div(slot="first")
          ...
          p.moved_up(style="--delay: 1.25") ...and many more travel to Chittagong and present their latest fabric developments. Exchanging about developments, developing fabrics, and sourcing the right product at the right price, is a true everyday business.
        div(slot="last")
      ...
      Article
        div(slot="first")
          img.faded_out(src="/images/optimized/fabric_sourcing_2.jpg" style="--delay: 0.5")
          h3.faded_out(style="--delay: 0.75") China-2002
